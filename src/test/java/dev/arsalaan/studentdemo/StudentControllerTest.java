...
public class StudentControllerTest {
    ...
    public void createStudent_success() throws Exception {
        ...
        Mockito.when(studentService.createStudent(student1)).thenReturn(2);
    ...
    public void createStudent_emailTaken() throws Exception {
        ...
        Mockito.when(studentService.createStudent(student4)).thenReturn(1);
    ...
    public void updateStudent_success() throws Exception {
        ...
        Mockito.when(studentService.getStudentById(student1.getId())).thenReturn(student1);
        Mockito.when(studentService.updateStudent(student1.getId(), studentUpdate.getName(), studentUpdate.getEmail())).thenReturn(3);
    ...
    public void updateStudent_emailTaken() throws Exception {
        ...
        Mockito.when(studentService.getStudentById(student1.getId())).thenReturn(student1);
        Mockito.when(studentService.updateStudent(student1.getId(), studentOneUpdate.getName(), studentOneUpdate.getEmail())).thenReturn(2);
    ...
    public void updateStudent_studentNotFound() throws Exception {
        ...
        Mockito.when(studentService.updateStudent(studentUpdate.getId(), studentUpdate.getName(), studentUpdate.getEmail())).thenReturn(1);
    ...
    public void deleteStudentById_success() throws Exception {
        ...
        Mockito.when(studentService.deleteStudentById(student2.getId())).thenReturn(true);
    ...
    public void deleteStudentById_notFound() throws Exception {
        ...
        Mockito.when(studentService.deleteStudentById(studentDelete.getId())).thenReturn(false);
